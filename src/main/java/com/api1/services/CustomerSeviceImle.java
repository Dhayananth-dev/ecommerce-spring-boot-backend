...
import com.api1.dto.PaymentDto;
import com.api1.entity.Cart;
...
import com.api1.exception.OutOfStockException;
...
public class CustomerSeviceImle implements CustomerService{
	...
	public Map<String, Object> addToCart(Long id, String email, String size) {
		...
		CustomerUser customer = userDao.findCustomerByEmail(email);
